...
└── src/
    ├── 01-claude-101/
    ├── 02-ai-fluency-foundations/
    ├── 03-claude-code-in-action/
    ├── 04-intro-to-agent-skills/
    ├── 05-building-claude-api/
    ├── 06-intro-to-mcp/
    ├── 07-mcp-advanced-topics/
    ├── 08-claude-amazon-bedrock/
    ├── 09-claude-vertex-ai/
    ├── 10-ai-fluency-students/
...
- **`reflections.md`**: Personal insights on practical application.
